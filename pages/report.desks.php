<table class="table table-striped table-hover">
	...
	<tbody>
		...
		<tr dir-paginate="x in statics.data|itemsPerPage:itemsPerPage" total-items="total_count" current-page="page.pageNo" pagination-id="desk-list" ng-click="showAllReCeipt(x)">
			<td>{{x.DeskNo}}</td>
...
<div class="header-pagination">
	<dir-pagination-controls pagination-id="desk-list" max-size="30" direction-links="true" boundary-links="true" on-page-change="getData(newPageNumber)"></dir-pagination-controls>
</div>